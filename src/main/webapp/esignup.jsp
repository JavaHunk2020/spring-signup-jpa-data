  	...
  	<img src="https://cdn-icons-png.flaticon.com/512/5455/5455873.png" style="height: 200px;">
  	  <hr/>
  		...
  		<form action="updateSignup" method="post">
  		     ...
  		     <input type="text" name="username"  class="form-control" value="${signupDTO.username}" readonly="readonly">
  		      <label>Password :</label> 
  		     <input type="text" name="password"  class="form-control" value="${signupDTO.password}">
  		      <label>Email :</label> 
